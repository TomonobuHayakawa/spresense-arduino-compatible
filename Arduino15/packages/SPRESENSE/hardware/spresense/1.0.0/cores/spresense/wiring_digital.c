/*
  wiring_digital.c - digital I/O for the Spresense SDK
...
static const struct {
    ...
    { PIN_D29, PIN_SPI3_SCK      },
    { PIN_D30, PIN_SPI3_MISO     },
    { PIN_D31, PIN_SPI3_MOSI     },
    { PIN_D32, PIN_SPI3_CS0_X    },
    { PIN_D33, PIN_SDIO_CMDDIR   },
    { PIN_D34, PIN_SDIO_DIR0     },
    ...
    { PIN_D45, PIN_SDIO_CLK      },
    { PIN_D46, PIN_SDIO_CMD      },
    { PIN_D47, PIN_SDIO_DATA0    },
    { PIN_D48, PIN_SDIO_DATA1    },
    { PIN_D49, PIN_SDIO_DATA2    },
    { PIN_D50, PIN_SDIO_DATA3    },
};
